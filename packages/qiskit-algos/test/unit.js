...
const expectedCircuit = `// Cirtuit generated by QISKit.js, version: ${version}\n\n` +
                        'include "qelib1.inc";\n\n' +
                        'qreg q[4];\n' +
                        'creg c[4];\n\n' +
                        'h q[0];\n' +
...
describe('algos:buildCircuits', () => {
  ...
  it('should return a group of circuits for "lenght" option' +
  ...
  const message = 'should return a single circuits (keeping array format) for' +
